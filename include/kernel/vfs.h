...
#include <kernel/fs/vfs/inode_operations.h>
#include <kernel/fs/vfs/superblock_operations.h>
#include <kernel/fs/vfs/file_operations.h>
#include <kernel/fs/vfs/addrspace_operations.h>
...
struct vfsmount* vfs_kern_mount(struct fstype* type, int32 flags,
...
int32 vfs_rmdir(struct inode*, struct dentry*);
int32 vfs_unlink(struct inode*, struct dentry*);
int32 vfs_rename(struct inode*, struct dentry*, struct inode*, struct dentry*,
	       uint32);
