/*
 * RISC-V Atomic s_operations header
 * 
 ...
 */
 ...
 /**
	...
	* Atomically reads the value of @v.
	*/
 static inline int64 atomic64_read(const atomic64_t *v)
 {
		 return READ_ONCE(v->counter);
 }
 ...
 /**
	...
	* Atomically sets the value of @v to @i.
	*/
 static inline void atomic64_set(atomic64_t *v, int64 i)
 {
		 WRITE_ONCE(v->counter, i);
 }
 ...
 /**
	...
	* Atomically adds @i to @v.
	*/
 static inline void atomic64_add(int64 i, atomic64_t *v)
 {
		 __asm__ __volatile__ (
				 "amoadd.d zero, %1, %0"
				 : "+A" (v->counter)
 ...
 /**
	...
	* Atomically subtracts @i from @v.
	*/
 static inline void atomic64_sub(int64 i, atomic64_t *v)
 {
		 atomic64_add(-i, v);
 }
 ...
 /**
	...
	* Atomically adds @i to @v and returns @i + @v
	*/
 static inline int64 atomic64_add_return(int64 i, atomic64_t *v)
 {
		 int64 val;
 ...
 /**
	...
	* Atomically subtracts @i from @v and returns @v - @i
	*/
 static inline int64 atomic64_sub_return(int64 i, atomic64_t *v)
 {
 ...
 /**
	...
	* Atomically increments @v by 1 and returns the result.
	*/
 static inline int64 atomic64_inc_return(atomic64_t *v)
 {
 ...
 /**
	...
	* Atomically decrements @v by 1 and returns the result.
	*/
 static inline int64 atomic64_dec_return(atomic64_t *v)
 {
 ...
 /**
	...
	* Atomically exchanges the value of @v with @new and returns the old value.
	*/
 static inline int64 atomic64_xchg(atomic64_t *v, int64 new)
 {
		 int64 val;
 ...
 /**
	...
	* comparison is successful. Returns the previous value of @v.
	*/
 static inline int64 atomic64_cmpxchg(atomic64_t *v, int64 old, int64 new)
 {
		 int64 val;
 ...
 /* Atomic s_operations to memory barriers */
