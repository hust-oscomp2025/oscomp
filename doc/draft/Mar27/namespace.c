...
static int32 mount_id_counter = 0;
...
int32 do_mount(const char* dev_name, const char* path, const char* fstype, uint64 flags,
	...
	/* Set up mount point */
	mnt->mnt_mountpoint = dentry_ref(target_path.dentry);
...
static int32 iterate_mount_subtree(int32 (*f)(struct vfsmount*, void*), void* arg, struct vfsmount* root) {
    struct vfsmount* mnt;
    int32 res;
