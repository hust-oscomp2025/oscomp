...
ssize_t kernel_read(struct file* file, void* buf, size_t count, loff_t* pos) {
	...
	if (!file->f_operations->read && !file->f_operations->read_iter)
		return -EINVAL;
	...
	if (file->f_operations->read)
		ret = file->f_operations->read(file, buf, count, ppos);
	else
...
ssize_t kernel_write(struct file* file, const void* buf, size_t count, loff_t* pos) {
	...
	if (!file->f_operations->write && !file->f_operations->write_iter)
		return -EINVAL;
	...
	if (file->f_operations->write)
		ret = file->f_operations->write(file, buf, count, ppos);
	else
